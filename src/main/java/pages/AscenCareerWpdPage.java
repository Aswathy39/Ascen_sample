...
public class AscenCareerWpdPage 
{
	public WebDriver driver;
	SoftAssert softAssert =new SoftAssert();
	

	public  AscenCareerWpdPage(WebDriver driver)
	{
		this.driver=driver; 
	}
	...
	By wpdPage = By.xpath("//*[@id=\"top\"]/div[2]/div[2]/div/div[1]/div[1]/div[4]/a");
	...
	public void navigateTOCareerForm() throws Exception
	{
		  ...
		  Thread.sleep(3000); 
		  driver.findElement(wpdPage).click(); 
		  Allure.step("Clicked on button to navigate to Php developer leads page");
		  
		  // to compare actual and expected url matching or not
		  String ActUrlTxt1 =driver.getCurrentUrl();
		  String ExpUrlTxt1 = "https://ascensor.stage.ascensor.co.uk/careers/wordpress-developer-leeds";
