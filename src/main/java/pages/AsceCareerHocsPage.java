...
public class AsceCareerHocsPage
{
	public WebDriver driver;
	SoftAssert softAssert =new SoftAssert();
	

	public  AsceCareerHocsPage(WebDriver driver)
	{
		this.driver=driver; 
	}
	...
	By hocsPage = By.xpath("//*[@id=\"top\"]/div[2]/div[2]/div/div[1]/div[1]/div[5]/a");
	...
	By submitBtn = By.xpath("//*[@id=\"top\"]/div[2]/div[2]/div/div/div/div/form/div[7]/button");
	...
	public void navigateTOCareerForm() throws Exception
	{
		  ...
		  Thread.sleep(2000); 
		  driver.findElement(hocsPage).click(); 
		  Allure.step("Clicked on button to navigate to digital project manager page");
		  
		  // to compare actual and expected url matching or not
		  String ActUrlTxt1 =driver.getCurrentUrl();
		  String ExpUrlTxt1 = "https://ascensor.stage.ascensor.co.uk/careers/head-of-client-services-leeds";
