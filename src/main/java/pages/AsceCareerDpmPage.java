...
import io.qameta.allure.Allure;
	...
	public class AsceCareerDpmPage 
	{
		...
		public  AsceCareerDpmPage(WebDriver driver)
		{
			this.driver=driver; 
		}
		...
		By dpmPage = By.xpath("//*[@id=\"top\"]/div[2]/div[2]/div/div[1]/div[1]/div[3]/a");
		...
		public void navigateTOCareerForm() throws Exception
		{
			  ...
			  Thread.sleep(2000); 
			  driver.findElement(dpmPage).click(); 
			  Allure.step("Clicked on button to navigate to digital project manager page");
			  
			  // to compare actual and expected url matching or not
			  String ActUrlTxt1 =driver.getCurrentUrl();
			  String ExpUrlTxt1 = "https://ascensor.stage.ascensor.co.uk/careers/digital-project-manager-leeds";
